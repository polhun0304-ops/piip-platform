...
async function getS3ObjectStream(params) {
    ...
    const contentType = typeof out.ContentType === "string" ? out.ContentType : undefined;
    const contentLength = typeof out.ContentLength === "number" ? out.ContentLength : undefined;
