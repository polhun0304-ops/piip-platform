...
tools: ["evidence_chain_validator", "ocr_analysis_trigger", "timeline_compiler"],
temperature: 0.3,
maxTokens: 2600
},
analysis: {
...
tools: ["case_registry_lookup", "timeline_compiler", "subject_profile_scan"],
temperature: 0.5,
maxTokens: 3200
},
reporting: {
...
tools: ["report_template_builder", "evidence_chain_validator", "case_registry_lookup"],
temperature: 0.35,
maxTokens: 3800
},
consultation: {
...
tools: ["evidence_chain_validator", "case_registry_lookup", "subject_profile_scan"],
temperature: 0.2,
maxTokens: 2400
}
};
