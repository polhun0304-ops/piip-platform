    ...
    const templates = [
        {
            ...
            conversationFlow: [
                {
                    step: 1,
                    message: "불륜조사 의뢰를 시작하겠습니다. 먼저, 조사 대상자의 성함을 알려주시겠어요?",
                    expectedFields: ["targetName"],
                },
                {
                    step: 2,
                    message: "조사 대상자와는 어떤 관계이신가요? (배우자, 연인, 약혼자 등)",
                    expectedFields: ["relationship"],
                },
                {
                    step: 3,
                    message: "불륜을 의심하게 된 구체적인 이유나 상황을 설명해 주시겠어요?",
                    expectedFields: ["suspicionReason"],
                },
                {
                    step: 4,
                    message: "의심되는 상대방이 있으신가요? 있다면 이름이나 특징을 알려주세요. (선택사항)",
                    expectedFields: ["suspectedPerson"],
                },
                {
                    step: 5,
                    message: "조사 대상자의 평소 일정(출퇴근 시간, 주말 활동 등)을 알려주시면 조사에 도움이 됩니다.",
                    expectedFields: ["targetSchedule", "targetPhone"],
                },
                {
                    step: 6,
                    message: "마지막으로 의뢰인님의 연락처를 남겨주세요. 담당 탐정이 연락드리겠습니다.",
        ...
        {
            name: "소재파악",
            description: "연락이 두절된 사람, 채무자, 가족 등의 현재 위치와 연락처를 찾는 조사입니다.",
            sortOrder: 2,
            fields: [
                {
                    key: "targetName",
            ...
            conversationFlow: [
                {
                    step: 1,
                    message: "소재파악 의뢰를 도와드리겠습니다. 찾으려는 분의 성함이 어떻게 되시나요?",
                    expectedFields: ["targetName"],
                },
                {
                    step: 2,
                ...
                {
                    step: 5,
                    message: "그분에 대해 알고 계신 정보(직장, 차량, 지인 등)가 있으면 모두 알려주세요.",
        ...
        {
            name: "신원조사",
            description: "결혼 예정자, 사업 파트너, 직원 등의 신원과 신용도를 확인하는 조사입니다.",
            sortOrder: 3,
            fields: [
                {
                    key: "targetName",
            ...
            conversationFlow: [
                {
                    step: 1,
                    message: "신원조사 의뢰를 시작하겠습니다. 조사 대상자의 성함을 알려주세요.",
                    expectedFields: ["targetName"],
                },
                {
                    step: 2,
                    message: "어떤 목적으로 신원조사가 필요하신가요? (결혼, 사업, 채용 등)",
                    expectedFields: ["investigationType"],
                },
                {
                    step: 3,
                    message: "구체적으로 확인하고 싶은 사항이 있으신가요? (학력, 경력, 재산, 신용 등)",
                    expectedFields: ["concernAreas"],
                },
                {
                    step: 4,
                    message: "조사에 도움이 될 정보(주소, 직장 등)를 알고 계시면 알려주세요.",
                    expectedFields: [
                        "targetAddress",
                        "targetWorkplace",
                        "targetBirthYear",
